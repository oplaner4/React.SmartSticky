...
import { StickyBottomOnMobilePhones } from "./lib/StickyBottomOnMobilePhones";
...
import { StickyTableHeader } from "./lib/StickyTableHeader";
  ...
  return (
    <Container className="p-4">
      ...
      <Row className="mb-2">
        <Col md={6} lg={4}>
          ...
          <p>
            ...
            ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet enim. Duis condimentum augue id magna
            semper rutrum. Nullam sit amet magna in magna gravida vehicula. Etiam bibendum elit eget erat. Class aptent
            taciti sociosqu ad litora torquent per conubia nostra, per inceptos hymenaeos. Donec quis nibh at felis
            congue commodo. Morbi leo mi, nonummy eget tristique non, rhoncus non leo. Nullam justo enim, consectetuer
            nec, ullamcorper ac, vestibulum in, elit. Integer rutrum, orci vestibulum ullamcorper ultricies, lacus quam
            ultricies odio, vitae placerat pede sem sit amet enim. Vestibulum fermentum tortor id mi. Praesent vitae
            arcu tempor neque lacinia pretium. Maecenas fermentum, sem in pharetra pellentesque, velit turpis volutpat
            ante, in pharetra metus odio a lectus. Temporibus autem quibusdam et aut officiis debitis aut rerum
            necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. In rutrum.
            Maecenas ipsum velit, consectetuer eu lobortis ut, dictum at dui. Duis aute irure dolor in reprehenderit in
            voluptate velit esse cillum dolore eu fugiat nulla pariatur. Duis ante orci, molestie vitae vehicula
            venenatis, tincidunt ac pede. Praesent id justo in neque elementum ultrices.
          </p>
          <p>
            ...
            officia deserunt mollit anim id est laborum. Nullam justo enim, consectetuer nec, ullamcorper ac, vestibulum
            in, elit. Cras elementum.
          </p>
          <p>
          ...
          <p>
            ...
            ea commodi consequatur? Nulla turpis magna, cursus sit amet, suscipit a, interdum id, felis. Aliquam id
            dolor. Etiam dictum tincidunt diam. Maecenas sollicitudin. Pellentesque pretium lectus id turpis. Aliquam id
            dolor. Fusce aliquam vestibulum ipsum. Duis bibendum, lectus ut viverra rhoncus, dolor nunc faucibus libero,
            eget facilisis enim ipsum id lacus. Proin in tellus sit amet nibh dignissim sagittis. Sed elit dui,
            pellentesque a, faucibus vel, interdum nec, diam. Duis bibendum, lectus ut viverra rhoncus, dolor nunc
            faucibus libero, eget facilisis enim ipsum id lacus. Nulla est.
          </p>
          <p>
            Nullam sit amet magna in magna gravida vehicula. Etiam posuere lacus quis dolor. Nulla turpis magna, cursus
            sit amet, suscipit a, interdum id, felis. Etiam bibendum elit eget erat. Integer malesuada. Nunc dapibus
            tortor vel mi dapibus sollicitudin. Quisque tincidunt scelerisque libero. Vivamus ac leo pretium faucibus.
            Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non
            numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Aliquam ante.
          </p>
        </Col>
        <Col md={6} lg={4}>
      ...
      <Row className="mb-2">
        <Col md={6} lg={4}>
          <table className="table table-dark table-hover">
            <StickyTableHeader enabled={globallyEnabled} />
            <tbody>
              <tr>
                <td>a</td>
                <td>b</td>
      ...
      <Row className="bg-light mb-2">
        <Col md={6} lg={4}>
          <StickyBottomOnMobilePhones enabled={globallyEnabled} />
          <p>
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Integer rutrum, orci vestibulum ullamcorper
            ultricies, lacus quam ultricies odio, vitae placerat pede sem sit amet enim. Duis condimentum augue id magna
            semper rutrum. Nullam sit amet magna in magna gravida vehicula. Etiam bibendum elit eget erat. Class aptent
